...
export default function LanguageIcon({ languageId, className = "w-4 h-4" }: LanguageIconProps) {
  const id = languageId.toLowerCase();

  // Ensure the icon is never squished or vanished in flex layouts on mobile devices
  ...
  switch (id) {
    ...
    case 'c':
      return (
        <svg viewBox="0 0 128 128" className={className} xmlns="http://www.w3.org/2000/svg">
          <path fill="#3c7fbe" d="M125 50c-4-32-24-50-62-50C29 0 3 24 3 64c0 39 24 64 64 64 32 0 55-19 58-50H87c-2 11-8 20-20 20-21 0-24-16-24-33 0-23 8-35 22-35 13 0 20 7 22 20z" />
        </svg>
      );
    case 'java':
      return (
    ...
    case 'php':
      return (
        <svg viewBox="0 0 24 24" className={className} xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="50%" y="62%" textAnchor="middle" fill="#ffffff" fontSize="9" fontWeight="bold" fontFamily="sans-serif">php</text>
        </svg>
      );
    case 'ruby':
      return (
        <svg viewBox="0 0 128 128" className={className} xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="ruby-grad-a" gradientUnits="userSpaceOnUse" x1="157.08" y1="2382.05" x2="131.682" y2="2426.892" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#FB7655"/><stop offset="0" stopColor="#FB7655"/><stop offset=".41" stopColor="#E42B1E"/><stop offset=".99" stopColor="#900"/><stop offset="1" stopColor="#900"/></linearGradient>
            <linearGradient id="ruby-grad-b" gradientUnits="userSpaceOnUse" x1="169.731" y1="2419.72" x2="136.998" y2="2441.685" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#871101"/><stop offset="0" stopColor="#871101"/><stop offset=".99" stopColor="#911209"/><stop offset="1" stopColor="#911209"/></linearGradient>
            <linearGradient id="ruby-grad-c" gradientUnits="userSpaceOnUse" x1="143.542" y1="2380.69" x2="110.81" y2="2402.655" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#871101"/><stop offset="0" stopColor="#871101"/><stop offset=".99" stopColor="#911209"/><stop offset="1" stopColor="#911209"/></linearGradient>
            <linearGradient id="ruby-grad-d" gradientUnits="userSpaceOnUse" x1="74.817" y1="2435.622" x2="79.891" y2="2402.644" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#fff"/><stop offset="0" stopColor="#fff"/><stop offset=".23" stopColor="#E57252"/><stop offset=".46" stopColor="#DE3B20"/><stop offset=".99" stopColor="#A60003"/><stop offset="1" stopColor="#A60003"/></linearGradient>
            <linearGradient id="ruby-grad-e" gradientUnits="userSpaceOnUse" x1="109.719" y1="2466.413" x2="111.589" y2="2432.757" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#fff"/><stop offset="0" stopColor="#fff"/><stop offset=".23" stopColor="#E4714E"/><stop offset=".56" stopColor="#BE1A0D"/><stop offset=".99" stopColor="#A80D00"/><stop offset="1" stopColor="#A80D00"/></linearGradient>
            <linearGradient id="ruby-grad-f" gradientUnits="userSpaceOnUse" x1="140.691" y1="2497.523" x2="146.289" y2="2473.401" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#fff"/><stop offset="0" stopColor="#fff"/><stop offset=".18" stopColor="#E46342"/><stop offset=".4" stopColor="#C82410"/><stop offset=".99" stopColor="#A80D00"/><stop offset="1" stopColor="#A80D00"/></linearGradient>
            <linearGradient id="ruby-grad-g" gradientUnits="userSpaceOnUse" x1="123.6" y1="2506.018" x2="147.719" y2="2518.077" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#fff"/><stop offset="0" stopColor="#fff"/><stop offset=".54" stopColor="#C81F11"/><stop offset=".99" stopColor="#BF0905"/><stop offset="1" stopColor="#BF0905"/></linearGradient>
            <linearGradient id="ruby-grad-h" gradientUnits="userSpaceOnUse" x1="53.674" y1="2444.028" x2="55.66" y2="2424.153" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#fff"/><stop offset="0" stopColor="#fff"/><stop offset=".31" stopColor="#DE4024"/><stop offset=".99" stopColor="#BF190B"/><stop offset="1" stopColor="#BF190B"/></linearGradient>
            <linearGradient id="ruby-grad-i" gradientUnits="userSpaceOnUse" x1="40.026" y1="2418.781" x2="133.345" y2="2514.739" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#BD0012"/><stop offset="0" stopColor="#BD0012"/><stop offset=".07" stopColor="#fff"/><stop offset=".17" stopColor="#fff"/><stop offset=".27" stopColor="#C82F1C"/><stop offset=".33" stopColor="#820C01"/><stop offset=".46" stopColor="#A31601"/><stop offset=".72" stopColor="#B31301"/><stop offset=".99" stopColor="#E82609"/><stop offset="1" stopColor="#E82609"/></linearGradient>
            <linearGradient id="ruby-grad-j" gradientUnits="userSpaceOnUse" x1="111.507" y1="2409.102" x2="83.398" y2="2416.039" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#8C0C01"/><stop offset="0" stopColor="#8C0C01"/><stop offset=".54" stopColor="#990C00"/><stop offset=".99" stopColor="#A80D0E"/><stop offset="1" stopColor="#A80D0E"/></linearGradient>
            <linearGradient id="ruby-grad-k" gradientUnits="userSpaceOnUse" x1="159.785" y1="2442.837" x2="134.814" y2="2465.217" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#7E110B"/><stop offset="0" stopColor="#7E110B"/><stop offset=".99" stopColor="#9E0C00"/><stop offset="1" stopColor="#9E0C00"/></linearGradient>
            <linearGradient id="ruby-grad-l" gradientUnits="userSpaceOnUse" x1="168.959" y1="2483.901" x2="156.521" y2="2497.199" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#79130D"/><stop offset="0" stopColor="#79130D"/><stop offset=".99" stopColor="#9E120B"/><stop offset="1" stopColor="#9E120B"/></linearGradient>
            <radialGradient id="ruby-grad-m" cx="138.703" cy="2464.789" r="30.601" gradientTransform="matrix(1 0 0 -1 -47.5 2517)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#A80D00"/><stop offset="0" stopColor="#A80D00"/><stop offset=".99" stopColor="#7E0E08"/><stop offset="1" stopColor="#7E0E08"/></radialGradient>
            <radialGradient id="ruby-grad-n" cx="96.325" cy="2424.465" r="40.679" gradientTransform="matrix(1 0 0 -1 -47.5 2517)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#A30C00"/><stop offset="0" stopColor="#A30C00"/><stop offset=".99" stopColor="#800E08"/><stop offset="1" stopColor="#800E08"/></radialGradient>
            <linearGradient id="ruby-grad-o" gradientUnits="userSpaceOnUse" x1="67.509" y1="2393.115" x2="57.373" y2="2427.506" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#8B2114"/><stop offset="0" stopColor="#8B2114"/><stop offset=".43" stopColor="#9E100A"/><stop offset=".99" stopColor="#B3100C"/><stop offset="1" stopColor="#B3100C"/></linearGradient>
            <linearGradient id="ruby-grad-p" gradientUnits="userSpaceOnUse" x1="145.272" y1="2507.076" x2="167.996" y2="2497.045" gradientTransform="matrix(1 0 0 -1 -47.5 2517)"><stop offset="0" stopColor="#B31000"/><stop offset="0" stopColor="#B31000"/><stop offset=".44" stopColor="#910F08"/><stop offset=".99" stopColor="#791C12"/><stop offset="1" stopColor="#791C12"/></linearGradient>
          </defs>
          <path fill="url(#ruby-grad-a)" d="M97.078 83.214L28.34 124.031l89.003-6.04 6.855-89.745z"/>
          <path fill="url(#ruby-grad-b)" d="M117.488 117.93l-7.649-52.799-20.837 27.514z"/>
          <path fill="url(#ruby-grad-c)" d="M117.592 117.93l-56.044-4.399-32.91 10.385z"/>
          <path fill="url(#ruby-grad-d)" d="M28.717 123.928l14.001-45.867-30.81 6.588z"/>
          <path fill="url(#ruby-grad-e)" d="M88.996 92.797l-12.882-50.46-36.866 34.558z"/>
          <path fill="url(#ruby-grad-f)" d="M121.275 43.047L86.426 14.585l-9.704 31.373z"/>
          <path fill="url(#ruby-grad-g)" d="M104.978 4.437L84.481 15.764 71.551 4.285z"/>
          <path fill="url(#ruby-grad-h)" d="M3.802 100.034l8.586-15.659L5.442 65.72z"/>
          ...
          <path fill="url(#ruby-grad-i)" d="M29.519 29.521c17.882-17.73 40.937-28.207 49.785-19.28 8.843 8.926-.534 30.62-18.418 48.345-17.884 17.725-40.653 28.779-49.493 19.852-8.849-8.92.242-31.191 18.126-48.917z"/>
          <path fill="url(#ruby-grad-j)" d="M28.717 123.909l13.89-46.012 46.135 14.82c-16.68 15.642-35.233 28.865-60.025 31.192z"/>
          <path fill="url(#ruby-grad-k)" d="M77.062 45.831l11.844 46.911c13.934-14.65 26.439-30.401 32.563-49.883l-44.407 2.972z"/>
          <path fill="url(#ruby-grad-l)" d="M121.348 43.097c4.74-14.305 5.833-34.825-16.517-38.635l-18.339 10.13 34.856 28.505z"/>
          <path fill="#9E1209" d="M3.802 99.828c.656 23.608 17.689 23.959 24.945 24.167l-16.759-39.14-8.186 14.973z"/>
          <path fill="url(#ruby-grad-m)" d="M77.128 45.904c10.708 6.581 32.286 19.798 32.723 20.041.68.383 9.304-14.542 11.261-22.976l-43.984 2.935z"/>
          <path fill="url(#ruby-grad-n)" d="M42.589 77.897l18.57 35.828c10.98-5.955 19.579-13.211 27.454-20.983L42.589 77.897z"/>
          <path fill="url(#ruby-grad-o)" d="M11.914 84.904l-2.631 31.331c4.964 6.781 11.794 7.371 18.96 6.842-5.184-12.9-15.538-38.696-16.329-38.173z"/>
          <path fill="url(#ruby-grad-p)" d="M86.384 14.67l36.891 5.177c-1.969-8.343-8.015-13.727-18.32-15.41L86.384 14.67z"/>
        </svg>
      );
    case 'kotlin':
      return (
        <svg viewBox="0 0 128 128" className={className} xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="kotlin-grad-logo-new" x1="500.003" x2="-.097" y1="579.106" y2="1079.206" gradientTransform="translate(15.534 -96.774) scale(.1939)" gradientUnits="userSpaceOnUse">
              <stop offset=".003" stopColor="#e44857"/>
              <stop offset=".469" stopColor="#c711e1"/>
              <stop offset="1" stopColor="#7f52ff"/>
            </linearGradient>
          </defs>
          <path fill="url(#kotlin-grad-logo-new)" d="M112.484 112.484H15.516V15.516h96.968L64 64Zm0 0"/>
        </svg>
      );
    case 'csharp':
      return (
        <svg viewBox="0 0 128 128" className={className} xmlns="http://www.w3.org/2000/svg">
          ...
          <path fill="#fff" d="M85.3 76.1C81.1 83.5 73.1 88.5 64 88.5c-13.5 0-24.5-11-24.5-24.5s11-24.5 24.5-24.5c9.1 0 17.1 5 21.3 12.5l13-7.5c-6.8-11.9-19.6-20-34.3-20-21.8 0-39.5 17.7-39.5 39.5s17.7 39.5 39.5 39.5c14.6 0 27.4-8 34.2-19.8l-12.9-7.6zM97 66.2l.9-4.3h-4.2v-4.7h5.1L100 51h4.9l-1.2 6.1h3.8l1.2-6.1h4.8l-1.2 6.1h2.4v4.7h-3.3l-.9 4.3h4.2v4.7h-3.3l-.9 4.3h4.2v4.7h-5.1l-1.2 6h-4.9l1.2-6h-3.8l-1.2 6h-4.8l-1.2 6h-2.4v-6.2z"/>
        </svg>
      );
    case 'dart':
      return (
    ...
    case 'bash':
      return (
        <svg viewBox="0 0 128 128" className={className} xmlns="http://www.w3.org/2000/svg">
          <rect width="128" height="128" rx="28" fill="#1e2235" stroke="rgba(255,255,255,0.06)" strokeWidth="4" />
          <path d="M36 42 l24 18 l-24 18" fill="none" stroke="#10b981" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
          <line x1="68" y1="78" x2="94" y2="78" stroke="#10b981" strokeWidth="10" strokeLinecap="round" />
        </svg>
      );
    case 'mysql':
      return (
        <svg viewBox="0 0 128 128" className={className} xmlns="http://www.w3.org/2000/svg">
          <path fill="#00618A" d="M117.688 98.242c-6.973-.191-12.297.461-16.852 2.379-1.293.547-3.355.559-3.566 2.18.711.746.82 1.859 1.387 2.777 1.086 1.754 2.922 4.113 4.559 5.352 1.789 1.348 3.633 2.793 5.551 3.961 3.414 2.082 7.223 3.27 10.504 5.352 1.938 1.23 3.859 2.777 5.75 4.164.934.684 1.563 1.75 2.773 2.18v-.195c-.637-.812-.801-1.93-1.387-2.777l-2.578-2.578c-2.52-3.344-5.719-6.281-9.117-8.719-2.711-1.949-8.781-4.578-9.91-7.73l-.199-.199c1.922-.219 4.172-.914 5.949-1.391 2.98-.797 5.645-.59 8.719-1.387l4.164-1.187v-.793c-1.555-1.594-2.664-3.707-4.359-5.152-4.441-3.781-9.285-7.555-14.273-10.703-2.766-1.746-6.184-2.883-9.117-4.363-.988-.496-2.719-.758-3.371-1.586-1.539-1.961-2.379-4.449-3.566-6.738-2.488-4.793-4.93-10.023-7.137-15.066-1.504-3.437-2.484-6.828-4.359-9.91-9-14.797-18.687-23.73-33.695-32.508-3.195-1.867-7.039-2.605-11.102-3.57l-6.543-.395c-1.332-.555-2.715-2.184-3.965-2.977C16.977 3.52 4.223-3.312.539 5.672-1.785 11.34 4.016 16.871 6.09 19.746c1.457 2.012 3.32 4.273 4.359 6.539.688 1.492.805 2.984 1.391 4.559 1.438 3.883 2.695 8.109 4.559 11.695.941 1.816 1.98 3.727 3.172 5.352.727.996 1.98 1.438 2.18 2.973-1.227 1.715-1.297 4.375-1.984 6.543-3.098 9.77-1.926 21.91 2.578 29.137 1.383 2.223 4.641 6.98 9.117 5.156 3.918-1.598 3.043-6.539 4.164-10.902.254-.988.098-1.715.594-2.379.996-1.32.996-3.078 1.98-4.551.497-.738 1.72-1.258 2.18-2.18-.754-.75-.828-1.848-1.39-2.766-1.637-2.672-3.035-5.59-4.55-8.328-.59-.988-1.723-1.258-2.18-2.18 1.96-1.961 4.453-2.383 6.738-3.563a613.626 613.626 0 0 1 15.066-7.137c3.434-1.504 6.828-2.484 9.907-4.359l.199.199c-.754.75-.828 1.844-1.387 2.766-1.625 2.656-3.023 5.582-4.55 8.328-.594.992-1.727 1.258-2.184 2.184.754.75.828 1.848 1.39 2.766 1.637 2.668 3.032 5.586 4.551 8.328.594.988 1.727 1.258 2.18 2.18 1.543.5 2.777 1.75 4.363 2.18.992.27 1.93.816 2.973 1.188 3.887 1.437 8.113 2.695 11.695 4.558 1.816.941 3.73 1.98 5.352 3.172.996.727 1.438 1.98 2.977 2.18.496-1.23.754-2.715 1.582-3.371l6.738-3.563c4.793-2.488 10.027-4.93 15.066-7.137.992-.426 1.723.082 2.379-.594v1.387c-1.316.996-3.07 1.98-4.547 2.977-.742.5-1.262 1.723-2.184 2.184.75.754 1.848.828 2.766 1.387.688.422 1.238 1.09 1.98 1.39 1.746.708 3.567.809 5.352 1.387 2.66.863 5.32 1.586 7.926 2.773 1.961.895 3.707 2.227 5.55 3.371z" />
          <path fill="#F29111" d="M37.895 62.59c-2.316 2.508-4.633 5.484-6.336 8.516a70.82 70.82 0 0 0-5.742 13.664c-1.242 4.414-1.742 9.074-1.387 13.664.215 2.82.723 5.75 1.781 8.316.637 1.551 1.75 2.879 2.774 4.164.551-.551.465-1.57.594-2.375.523-3.238 1.43-6.539 2.578-9.516.988-2.558 1.922-5.184 3.367-7.531.723-1.184 2.227-1.762 2.773-2.969-.32-.977-.852-1.93-1.188-2.977l-1.98-6.137c-1.426-4.516-2.52-9.184-3.367-13.863-.129-.727-.273-1.637-.199-2.375-.02.438.07.828.133 1.426.438 4.293 1.422 8.71 2.375 12.871.934 4.07 1.848 8.246 3.168 12.277.551 1.68 1.754 3.035 2.578 4.555.551-.547.465-1.566.594-2.375.316-2.023 1.074-3.957 1.582-5.941 1.438-5.637 3.414-10.965 5.547-16.242.426-1.055 1.258-2.223 1.387-3.367-.32-.988-.852-1.93-1.188-2.977a164.444 164.444 0 0 1-5.148-18.703c-.277-1.352-.613-2.828-.992-4.164-.207.996-.289 2.086-.395 3.168z"/>
        </svg>
      );
    case 'r':
      return (
        <svg viewBox="0 0 724 561" className={className} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
          <defs>
            <linearGradient id="r-logo-g" x1="0" x2="1" y1="0" y2="1" gradientUnits="objectBoundingBox" spreadMethod="pad">
              <stop offset="0" stopColor="#cbced0" stopOpacity="1" />
              <stop offset="1" stopColor="#84838b" stopOpacity="1" />
            </linearGradient>
            <linearGradient id="r-logo-b" x1="0" x2="1" y1="0" y2="1" gradientUnits="objectBoundingBox" spreadMethod="pad">
              <stop offset="0" stopColor="#276dc3" stopOpacity="1" />
              <stop offset="1" stopColor="#165caa" stopOpacity="1" />
            </linearGradient>
          </defs>
          <path fill="url(#r-logo-g)" fillRule="evenodd" d="M361.453,485.937 C162.329,485.937 0.906,377.828 0.906,244.469 C0.906,111.109 162.329,3.000 361.453,3.000 C560.578,3.000 722.000,111.109 722.000,244.469 C722.000,377.828 560.578,485.937 361.453,485.937 ZM416.641,97.406 C265.289,97.406 142.594,171.314 142.594,262.484 C142.594,353.654 265.289,427.562 416.641,427.562 C567.992,427.562 679.687,377.033 679.687,262.484 C679.687,147.971 567.992,97.406 416.641,97.406 Z" />
          <path fill="url(#r-logo-b)" fillRule="evenodd" d="M550.000,377.000 C550.000,377.000 571.822,383.585 584.500,390.000 C588.899,392.226 596.510,396.668 602.000,402.500 C607.378,408.212 610.000,414.000 610.000,414.000 L696.000,559.000 L557.000,559.062 L492.000,437.000 C492.000,437.000 478.690,414.131 470.500,407.500 C463.668,401.969 460.755,400.000 454.000,400.000 C449.298,400.000 420.974,400.000 420.974,400.000 L421.000,558.974 L298.000,559.026 L298.000,152.938 L545.000,152.938 C545.000,152.938 657.500,154.967 657.500,262.000 C657.500,369.033 550.000,377.000 550.000,377.000 ZM496.500,241.024 L422.037,240.976 L422.000,310.026 L496.500,310.002 C496.500,310.002 531.000,309.895 531.000,274.877 C531.000,239.155 496.500,241.024 496.500,241.024 Z" />
        </svg>
      );
    default:
      return (
